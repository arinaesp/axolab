...
The only official axo channels are the Telegram Mini App, the axo Telegram group, and [@axo_manager](https://t.me/axo_manager). Any other account or bot acting on behalf of axo is unaffiliated. axo does not initiate private messages asking for payment, and never asks for passwords, Telegram login codes, SMS codes, or card CVV codes. See [Terms of Use §7](https://arinaesp.github.io/axo-landing/terms.html) for details.
